...
export class CartController {
  ...
  @Post('add')
  addProduct(@Req() req, @Body() body: AddToCartDto) {
  ...
  @Delete('remove')
  removeProduct(@Req() req, @Body() body: RemoveFromCartDto) {
    return this.cartService.removeProduct(req.user.userId, body.productId);
  }
